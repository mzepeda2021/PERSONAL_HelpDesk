...
class Email extends PHPMailer{
    ...
    protected $gCorreo = ''; //estan en blanco para evitar que alguien mas tome las credenciales profe, si se requieren hagamelo saber y se las comparto
    protected $gContrasena = ''; //estan en blanco para evitar que alguien mas tome las credenciales profe, si se requieren hagamelo saber y se las comparto
